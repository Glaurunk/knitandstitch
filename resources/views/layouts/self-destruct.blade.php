...
function bang()
    ...
    <div class="card-footer">
      ...
      <label for="button1">WARNING! DANGER!</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">WITH SANE MIND AND IN FULL KNOWLEDGE OF THE MATERIAL, LEGAL AND MORAL CONSEQUENCES OF THIS DECISION OF MINE, I HEREBY DECLARE THAT I WISH FOR THE COMPLETE, UTTER AND IRREVOCABLE DESTRUCTION OF THE PRESENT WEBPAGE.
      </div>
