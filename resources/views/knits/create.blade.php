...
<script src=" {{ url( '../vendor/unisharp/laravel-ckeditor/ckeditor.js')}}"></script>
  ...
  <form class="form pb-5" action="/knits" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
...
{{-- Inactive field --}}
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="price" value="{{ old('price') }}"></input>
      </div>

<!-- Enter from URL part for Main Picture -->
      <div class="form-group">
          <p style="color:black;">Main Picture Preview</p>
          <img name="img" class="img-fluid" id="cover" alt="cover" src="" style="max-width:200px;">
          <p id="photoPath" class="py-2">no main image selected</p>
